...
public class calculator {
	...
	private void initialize() {
		...
		frame.setBounds(100, 100, 365, 539);
		...
		btnSqrt.setFont(new Font("Tahoma", Font.BOLD, 17));
		...
		btnCos_1.setFont(new Font("Tahoma", Font.BOLD, 13));
		...
		btnTan_1.setFont(new Font("Tahoma", Font.BOLD, 13));
		...
		btnP_1.setFont(new Font("Tahoma", Font.BOLD, 16));
